...
public class Generator : MonoBehaviour
{
    ...
    public List<GameObject> preInitActiveRooms = new List<GameObject>();
    ...
    private void InstantiateRooms()
    {
        for (int i = 0; i < preInitActiveRooms.Count; i++)
        {
            ...
            var halfCurrentRoomSize  = (currentRoom.GetComponent<SpriteRenderer>().bounds.size.x / 2f);
            var halfPreviousRoomSize = (previousRoom.GetComponent<SpriteRenderer>().bounds.size.x / 2f);
